// build-nexe.js - Script to build the Discord Music Bot into an executable using nexe
const { execSync } = require('child_process');
const fs = require('fs');
const path = require('path');

console.log('🚀 Starting build process for Discord Music Bot using nexe...');
...
`;
  ...
  // Build the executable using nexe
  console.log('🔨 Building executable (this may take a few minutes)...');
  console.log('📦 Bundling dependencies and creating executable...');
  
  // Use nexe to build the executable with specific options
  execSync('nexe src/index.js -o dist/discord-music-bot.exe --target win-x64-16.17.0 --resource "src/**/*" --resource ".env" --resource "node_modules/**/*"', 
    { stdio: 'inherit' });
